(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var routes = [
                ...
                { path: 'user', loadChildren: function () { return Promise.resolve( /*! import() */).then(__webpack_require__.bind(null, /*! ./modules/usermodule/user.module */ "./src/app/modules/usermodule/user.module.ts")).then(function (module) { return module.usermodel; }); } }
            ];
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var contactComponent = /** @class */ (function () {
                function contactComponent(myUserService, myRouter) {
                    var _this = this;
                    ...
                    this.myUserService
                        ...
                        if (Response.message === "authentication failed") {
                            _this.myRouter.navigate(["user/signin"]);
                        }
                        else {
                            _this.contactdata = Response.user;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProfileComponent = /** @class */ (function () {
                function ProfileComponent(myUserService, myRouter) {
                    this.myUserService = myUserService;
                    this.myRouter = myRouter;
                    this.userauthenticated = false;
                }
                ...
                ProfileComponent.prototype.handlelogout = function () {
                    this.myUserService.logout().subscribe(function (Response) { });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SigninComponent = /** @class */ (function () {
                function SigninComponent(myUserService, myRouter) {
                    this.myUserService = myUserService;
                    this.myRouter = myRouter;
                    this.username = "";
                    this.password = "";
                    ...
                    if (username && password) {
                        this.myUserService
                            ...
                            if (Response.message === "success") {
                                _this.id = Response.user._id;
                                localStorage.setItem('Array', JSON.stringify(_this.id));
                                _this.myRouter.navigate(["/user/profile"]);
                            }
                            else {
                                _this.error = " user is not found  \n            please signup ";
                            }
                        });
                    }
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SignupComponent = /** @class */ (function () {
                function SignupComponent(myUserService, myRouter) {
                    this.myUserService = myUserService;
                    this.myRouter = myRouter;
                    this.username = "";
                    this.password = "";
                ...
                SignupComponent.prototype.handlesignup = function () {
                    var _this = this;
                    var _a = this, username = _a.username, password = _a.password, phone = _a.phone, email = _a.email;
                    if (username && password && phone && email) {
                        this.myUserService
                            .handlesignup({ username: username, password: password, phone: phone, email: email })
                            .subscribe(function (Response) {
                            if (Response.message === "error") {
                                _this.error = "user is exist";
                            }
                            else {
                                _this.myRouter.navigate(["/user/signin"]);
                            }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserService = /** @class */ (function () {
                ...
                UserService.prototype.handlesignup = function (data) {
                    return this.myHttpClient.post("signup", data);
                };
                UserService.prototype.handlesignin = function (data) {
        ...
        /***/ (function (module, exports, __webpack_require__) {
            module.exports = __webpack_require__(/*! C:\Users\abdo\Desktop\front\src\main.ts */ "./src/main.ts");
            /***/ 
        })
    }, [[0, "runtime", "vendor"]]]);
